...
import { Collapse } from "@/components/ui/motion" // Add this import at the top
            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                ...
                <Card>
                  <CardContent className="flex flex-row items-center gap-4 pt-6">
                    ...
                    <div>
                      ...
                      <h3 className="text-2xl font-bold">1,287</h3>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Card className="col-span-1">
                  <CardHeader>
                    <CardTitle>Top Talent by Industry</CardTitle>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="col-span-1">
                  <CardHeader>
                    <CardTitle>Founder Potential Score Distribution</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="h-[300px] flex items-center justify-center border-2 border-dashed rounded-xl">
                      <BarChart3 className="h-8 w-8 text-muted-foreground" />
